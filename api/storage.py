...
class StorageService:
    ...
    def update_model_metadata(self, model_id: str, updates: dict[str, Any]) -> dict[str, Any]:
    ...
    def load_model_artifact(self, model_id: str, artifact_name: str) -> Any:
        ...
        artifact_path = self.settings.storage_path / "models" / model_id / f"{artifact_name}.pkl"
    ...
    def load_results(self, model_id: str, results_type: str) -> dict[str, Any]:
        ...
        results_path = self.settings.storage_path / "results" / model_id / f"{results_type}.json"
