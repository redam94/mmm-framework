...
(`mmm_framework_server/main.py:450-473`).
...
validated fd (`mmm_framework_server/main.py:2723-2792`; `workspace.py:202-226`). *Caveat:* a narrow
...
via `install_audit_sink()` (FastAPI lifespan, `server/src/mmm_framework_server/main.py:167-169`); the
