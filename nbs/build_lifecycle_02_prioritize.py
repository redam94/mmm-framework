"""Author lifecycle_02_prioritize.ipynb — T1 of the series (run from ``nbs/``).
    ...
    uv run --with nbformat python build_lifecycle_02_prioritize.py
    TQDM_DISABLE=1 PYTHONPATH=.. uv run --with nbconvert --with nbformat --with ipykernel \
        jupyter nbconvert --to notebook --execute --inplace \
        lifecycle_02_prioritize.ipynb --ExecutePreprocessor.timeout=2400 \
...
def main() -> None:
    ...
    out = "lifecycle_02_prioritize.ipynb"
