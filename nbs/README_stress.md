...
pieces: `mmm_walkthrough.ipynb` (the same workflow arc on the tamer
...
PYTHONPATH=$(dirname $PWD) uv run jupyter nbconvert --to notebook --execute --inplace stress_00_the_rosy_picture.ipynb
```
