"""Author structural_nested_mmm.ipynb — the StructuralNestedMMM example notebook.
    ...
    uv run --with nbformat python builders/build_structural_nested.py
    TQDM_DISABLE=1 uv run --with nbconvert --with nbformat --with ipykernel \
        jupyter nbconvert --to notebook --execute --inplace \
        extensions/structural_nested_mmm.ipynb --ExecutePreprocessor.timeout=3600 \
...
def main() -> None:
    ...
    out = "extensions/structural_nested_mmm.ipynb"
