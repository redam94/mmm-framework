"""Author lifecycle_00_overview.ipynb — the series opener (run from ``nbs/``).
    ...
    uv run --with nbformat python builders/build_lifecycle_00_overview.py
    PYTHONPATH=.. uv run --with nbconvert --with nbformat --with ipykernel \
        jupyter nbconvert --to notebook --execute --inplace \
        lifecycle/lifecycle_00_overview.ipynb --ExecutePreprocessor.timeout=1800 \
...
def main() -> None:
    ...
    out = "lifecycle/lifecycle_00_overview.ipynb"
