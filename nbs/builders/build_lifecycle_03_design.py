"""Author lifecycle_03_design.ipynb — T2 of the series (run from ``nbs/``).
    ...
    uv run --with nbformat python builders/build_lifecycle_03_design.py
    TQDM_DISABLE=1 PYTHONPATH=.. uv run --with nbconvert --with nbformat --with ipykernel \
        jupyter nbconvert --to notebook --execute --inplace \
        lifecycle/lifecycle_03_design.ipynb --ExecutePreprocessor.timeout=2400 \
...
def main() -> None:
    ...
    out = "lifecycle/lifecycle_03_design.ipynb"
