"""Author workshop notebook 00 — Thinking in Distributions (run from ``nbs/``).
    ...
    uv run python builders/build_workshop_00_thinking_in_distributions.py
    PYTHONPATH=.. uv run jupyter nbconvert --to notebook --execute --inplace \
        workshop/workshop_00_thinking_in_distributions.ipynb --ExecutePreprocessor.timeout=2400
...
def main():
    ...
    path = "workshop/workshop_00_thinking_in_distributions.ipynb"
