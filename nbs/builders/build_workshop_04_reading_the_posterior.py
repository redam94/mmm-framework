"""Author workshop notebook 04 — Reading the Posterior (run from ``nbs/``).
    ...
    uv run python builders/build_workshop_04_reading_the_posterior.py
    PYTHONPATH=.. uv run jupyter nbconvert --to notebook --execute --inplace \
        workshop/workshop_04_reading_the_posterior.ipynb --ExecutePreprocessor.timeout=2400
...
[stress_00](../stress/stress_00_the_rosy_picture.ipynb) and friends.
...
def main():
    ...
    path = "workshop/workshop_04_reading_the_posterior.ipynb"
