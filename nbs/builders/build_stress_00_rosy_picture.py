"""Author the series-opener stress notebook (run from ``nbs/``).
    ...
    PYTHONPATH=.. uv run jupyter nbconvert --to notebook --execute --inplace \
        stress/stress_00_the_rosy_picture.ipynb --ExecutePreprocessor.timeout=2400
...
> Companions: `nbs/demos/mmm_walkthrough.ipynb` (the v1→v3 modeling workflow on the
...
def main():
    ...
    path = "stress/stress_00_the_rosy_picture.ipynb"
