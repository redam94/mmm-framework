"""Author stress notebook 02 — time structure (run from ``nbs/``).
    ...
    uv run python builders/build_stress_02_time_structure.py
    PYTHONPATH=.. uv run jupyter nbconvert --to notebook --execute --inplace \
        stress/stress_02_time_structure.ipynb --ExecutePreprocessor.timeout=2400
...
def main():
    ...
    path = "stress/stress_02_time_structure.ipynb"
