"""Author the Lydia Pinkham real-data pressure-test notebook (run from ``nbs/``).
    ...
    uv run python builders/build_pinkham_real_data.py
    uv run jupyter nbconvert --to notebook --execute --inplace \
        validation/pinkham_real_data.ipynb --ExecutePreprocessor.timeout=2400
...
> **Run it yourself.** This page mirrors `nbs/validation/pinkham_real_data.ipynb`
> (authored by `nbs/builders/build_pinkham_real_data.py`). Measured artifact:
...
def main():
    ...
    path = "validation/pinkham_real_data.ipynb"
