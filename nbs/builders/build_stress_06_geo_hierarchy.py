"""Author stress notebook 06 — geography & hierarchy (run from ``nbs/``).
    ...
    uv run python builders/build_stress_06_geo_hierarchy.py
    PYTHONPATH=.. uv run jupyter nbconvert --to notebook --execute --inplace \
        stress/stress_06_geography_and_hierarchy.ipynb --ExecutePreprocessor.timeout=2400
...
def main():
    ...
    path = "stress/stress_06_geography_and_hierarchy.ipynb"
