"""Author workshop notebook 03 — Your First MMM (run from ``nbs/``).
    ...
    PYTHONPATH=.. uv run jupyter nbconvert --to notebook --execute --inplace \
        workshop/workshop_03_first_mmm.ipynb --ExecutePreprocessor.timeout=2400
...
([stress_00](../stress/stress_00_the_rosy_picture.ipynb)) exists: it manufactures worlds
...
[../aurora/00_overview.ipynb](../aurora/00_overview.ipynb) tells a full modeling engagement as a
story (the Aurora notebooks), and
[../stress/stress_00_the_rosy_picture.ipynb](../stress/stress_00_the_rosy_picture.ipynb) shows the
...
def main():
    ...
    path = "workshop/workshop_03_first_mmm.ipynb"
