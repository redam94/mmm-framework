"""Author workshop notebook 05 — From Draws to Decisions (run from ``nbs/``).
    ...
    uv run python builders/build_workshop_05_from_draws_to_decisions.py
    PYTHONPATH=.. uv run jupyter nbconvert --to notebook --execute --inplace \
        workshop/workshop_05_from_draws_to_decisions.ipynb --ExecutePreprocessor.timeout=2400
...
- **All of this assumed the model is causally right.** Every distribution in
  ...
  *wrong about causality*: this clean world has no hidden demand driver, but
  ...
  ([stress_00](../stress/stress_00_the_rosy_picture.ipynb) for the doctrine,
  [stress_05](../stress/stress_05_the_gauntlet.ipynb) for everything-at-once). The fix
  ...
  ([math_05](../math/math_05_calibration.ipynb)).
"""),
    # ====================================================================
    # 9. Series close
    # ====================================================================
...
- **The Aurora story series** ([00_overview](../aurora/00_overview.ipynb) →
  05_unified_workflow) — the same framework on a richer fictional brand,
  told as a full analyst engagement.
- **The math series** ([math_00](../math/math_00_overview.ipynb)…math_06) — every
...
- **The stress series** ([stress_00](../stress/stress_00_the_rosy_picture.ipynb)…stress_06)
...
- **[../demos/mmm_walkthrough.ipynb](../demos/mmm_walkthrough.ipynb)** — the practitioner's
...
def main():
    ...
    path = "workshop/workshop_05_from_draws_to_decisions.ipynb"
