...
if __name__ == "__main__":
    write_notebook("aurora/00_overview.ipynb", nb_00(), "Aurora — Overview")
    write_notebook("aurora/01_causality.ipynb", nb_01(), "Aurora — Causality")
    write_notebook("aurora/02_base_mmm.ipynb", nb_02(), "Aurora — Base MMM")
    write_notebook("aurora/03_extended_mmm.ipynb", nb_03(), "Aurora — Extended MMM")
    write_notebook("aurora/04_reporting.ipynb", nb_04(), "Aurora — Reporting")
    write_notebook("aurora/05_unified_workflow.ipynb", nb_05(), "Aurora — Unified Workflow")
