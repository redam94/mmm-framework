"""Author stress notebook 01 — carryover & shape (run from ``nbs/``).
    ...
    uv run python builders/build_stress_01_carryover_shape.py
    PYTHONPATH=.. uv run jupyter nbconvert --to notebook --execute --inplace \
        stress/stress_01_carryover_and_shape.ipynb --ExecutePreprocessor.timeout=2400
...
def main():
    ...
    path = "stress/stress_01_carryover_and_shape.ipynb"
