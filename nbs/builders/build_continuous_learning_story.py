"""Author the *narrative* continuous-learning notebook (run from ``nbs/``).
    ...
    uv run --with nbformat python builders/build_continuous_learning_story.py
    PYTHONPATH=.. uv run --with nbconvert --with nbformat --with ipykernel --with kaleido \
        jupyter nbconvert --to notebook --execute --inplace \
        continuous_learning/continuous_learning_story.ipynb --ExecutePreprocessor.timeout=5400 \
...
def main() -> None:
    ...
    out = "continuous_learning/continuous_learning_story.ipynb"
