"""Generate stress_03_confounding_and_selection.ipynb (run from ``nbs/``).
    ...
    uv run python build_stress_03_confounding_selection.py
    PYTHONPATH=.. uv run jupyter nbconvert --to notebook --execute --inplace \
        stress_03_confounding_and_selection.ipynb --ExecutePreprocessor.timeout=2700
...
def main():
    ...
    path = "stress_03_confounding_and_selection.ipynb"
