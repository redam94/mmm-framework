...
- `00_overview.ipynb` … `05_unified_workflow.ipynb` — the **Aurora** story:
...
- `stress_00`–`stress_06` — the cold shower: worlds built to break the model,
  ...
  recover the truth. Read `stress_00_the_rosy_picture.ipynb` right after this
  series — it is the caveat workshop_02 §9 and workshop_05 §8 point at.
- `mmm_walkthrough.ipynb` — the practitioner's v1→v3 modeling loop on the
  `realistic` world.
