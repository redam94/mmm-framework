"""Author workshop notebook 02 — Sampling: How the Machine Works (run from ``nbs/``).
    ...
    uv run python build_workshop_02_sampling.py
    PYTHONPATH=.. uv run jupyter nbconvert --to notebook --execute --inplace \
        workshop_02_sampling.ipynb --ExecutePreprocessor.timeout=2400
...
[`stress_00_the_rosy_picture.ipynb`](stress_00_the_rosy_picture.ipynb), worth
...
def main():
    ...
    path = "workshop_02_sampling.ipynb"
