...
class MediatorConfigBuilder:
    ...
    def __init__(self, name: str):
        ...
        self._direct_effect = EffectPriorConfigBuilder().unconstrained(sigma=0.5).build()
    ...
    def with_direct_effect(self, sigma: float = 0.5) -> Self:
        ...
        self._allow_direct = True
        self._direct_effect = EffectPriorConfigBuilder().unconstrained(sigma=sigma).build()
        return self
    ...
    def with_slow_adstock(self, l_max: int = 12) -> Self:
        ...
        self._apply_adstock = True
        self._adstock = AdstockConfigBuilder().with_max_lag(l_max).with_slow_decay().build()
        return self
