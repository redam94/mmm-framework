...
(function() {
    ...
    const NAV_GROUPS = [
        ...
        },
        {
            ...
            items: [
                ...
                { href: 'experiment-playbook.html', label: 'Experiment Playbook' },
        ...
        },
        {
            ...
            items: [
                ...
                { href: 'finance-planning.html', label: 'Finance-Grade Planning' },
    ...
    const SERIES = {
        ...
        'Measurement research': [
            ...
            ['blog-mediation-funnel-identification.html', 'The Funnel Is Not Included'],
            ['blog-demand-proxy-proximal.html', 'Your Demand Proxy Is Not a Control'],
            ['blog-pricing-unmeasured-confounding.html', 'Two Ways to Price a Confounder You Cannot See'],
            ['blog-loo-is-the-wrong-cv.html', 'Your MMM Is Reporting the Wrong Cross-Validation'],
            ['blog-what-the-data-paid-for.html', 'How Many Parameters Did Your Data Pay For?'],
            ['blog-posterior-predictive-severity.html', 'A Posterior Predictive Check Cannot See What You Adjusted For'],
            ['blog-many-models-not-p-hacking.html', 'Fitting Many Models Is Not P-Hacking'],
            ['blog-prior-sensitivity-no-refit.html', 'Prior Sensitivity Without Refitting Anything'],
            ['blog-sbc-part-two.html', 'The Simulation Loop Does More Than SBC'],
            ['blog-auction-throttling-frontdoor.html', 'Randomization in the Auction'],
            ['blog-geo-experiments-tbr.html', 'Geo Experiments & TBR'],
            ['blog-switchback-experiments.html', 'Switchback Experiments'],
            ['blog-platform-divergent-delivery.html', 'The Platform Randomizes After You Do'],
            ...
            ['blog-p-hacking-evidence.html', 'P-Hacking & the Thin Evidence of a P-Value'],
            ['blog-p-values-across-models.html', 'A Smaller P-Value Is Not More Signal'],
            ['blog-testing-no-difference.html', 'Proving Nothing Happened'],
            ['blog-prior-predictive-sbc.html', 'Prior Predictive Checks & SBC'],
            ['blog-when-sampling-fails.html', 'When Sampling Fails'],
    ...
    const PAGE_TIERS = {
        ...
        'experiment-playbook.html': TIER_ANALYST,
    ...
    'finance-planning.html': TIER_ANALYST,
        ...
        'blog-calibrating-mmm-experiments.html': TIER_ANALYST,
        'blog-p-hacking-evidence.html': TIER_ANALYST,
        'blog-p-values-across-models.html': TIER_ANALYST,
        'blog-testing-no-difference.html': TIER_ANALYST,
        ...
        'blog-mediation-funnel-identification.html': TIER_TECHNICAL,
        'blog-demand-proxy-proximal.html': TIER_TECHNICAL,
        'blog-pricing-unmeasured-confounding.html': TIER_TECHNICAL,
        'blog-loo-is-the-wrong-cv.html': TIER_TECHNICAL,
        'blog-what-the-data-paid-for.html': TIER_TECHNICAL,
        'blog-posterior-predictive-severity.html': TIER_TECHNICAL,
        'blog-many-models-not-p-hacking.html': TIER_TECHNICAL,
        'blog-prior-sensitivity-no-refit.html': TIER_TECHNICAL,
        'blog-sbc-part-two.html': TIER_TECHNICAL,
        'blog-auction-throttling-frontdoor.html': TIER_TECHNICAL,
        'blog-switchback-experiments.html': TIER_TECHNICAL,
        'blog-saturation-or-fatigue.html': TIER_TECHNICAL,
        'blog-baseline-regularization-confounding.html': TIER_TECHNICAL,
        'blog-prior-predictive-sbc.html': TIER_TECHNICAL,
        'blog-when-sampling-fails.html': TIER_TECHNICAL,
